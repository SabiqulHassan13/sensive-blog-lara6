			...
			<div class="row">
				<div class="col-lg-8 post-list">
					...
					<section class="post-area">
						...
						<div class="single-post-item">
							<figure>
								<img class="post-img img-fluid" src="{{ asset('frontend') }}/img/posts/p2.jpg" alt="">
							</figure>
							<h3>
						...
						<div class="single-post-item">
							<figure>
								<img class="post-img img-fluid" src="{{ asset('frontend') }}/img/posts/p3.jpg" alt="">
							</figure>
							<h3>
						...
						<div class="single-post-item">
							<figure>
								<img class="post-img img-fluid" src="{{ asset('frontend') }}/img/posts/p4.jpg" alt="">
							</figure>
							<h3>
						...
						<div class="single-post-item">
							<figure>
								<img class="post-img img-fluid" src="{{ asset('frontend') }}/img/posts/p5.jpg" alt="">
							</figure>
							<h3>
